...
public class Conveyor extends JFrame {
	...
	public Conveyor() {
		...
		eReady.addActionListener(new SignalClient(Ports.PORT_LOADER_CONTROLLER, Ports.EBR));
		JButton AtPos1  = new JButton("bottleAtPos1");
		AtPos1 .addActionListener(new SignalClient(Ports.PORT_LOADER_CONTROLLER, Ports.ATPOS1));
		JButton AtPos5  = new JButton("bottleAtPos5");
		AtPos5.addActionListener(new SignalClient(Ports.PORT_LOADER_CONTROLLER, Ports.ATPOS5));
...
////
		...
		LeftPos5.addActionListener(new SignalCheckBoxClient(Ports.PORT_LOADER_CONTROLLER, Ports.LEFTPOS5));
